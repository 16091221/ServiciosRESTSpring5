...
import com.desv4j.users.entities.Role;
import com.desv4j.users.services.RoleService;
...
public class RoleController {
	...
	@PutMapping("/{roleId}")
	public ResponseEntity<Role> udateRoles(@PathVariable("roleId")Integer roleId, @RequestBody Role role){
